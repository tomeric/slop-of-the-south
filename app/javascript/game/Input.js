...
export class Input {
  ...
  get ability()   { return this.consume("KeyE") }     // a one-shot trick: the rocket, the blade
  get thrust()    { return this.keys.has("KeyE") }     // ...or held down, for the monster truck's thrusters
